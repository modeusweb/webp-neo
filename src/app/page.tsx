        ...
        <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-5xl flex-col px-4 pb-8 sm:px-6">
          <header className="pt-10 pb-8 text-center">
            ...
            <h1 className="mt-5 text-3xl font-bold tracking-tight sm:text-4xl">
              {/* The brand name is the hero: bigger than everything around it,
                  painted with the logo gradient and a slow sheen. */}
              <span className="brand-wordmark block text-4xl font-black tracking-tight sm:text-5xl lg:text-6xl">
                WebP Neo
              </span>
              <span
                aria-hidden="true"
                className="mx-auto mt-3 block h-1 w-24 rounded-full bg-gradient-to-r from-violet-500 via-fuchsia-500 to-amber-400 sm:w-32"
              />
              {/* Supporting tagline, kept in muted type so the brand stays the
                  loudest element in the hero. */}
              {' '}
              <span className="mt-3 block text-base font-medium text-slate-300 sm:text-lg">
          ...
          <footer className="mt-6 flex flex-col items-center justify-center gap-2 text-xs text-slate-500 sm:flex-row">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-1.5 text-slate-400 transition-colors hover:text-violet-400"
            >
